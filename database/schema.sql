CREATE TABLE IF NOT EXISTS users (
    ...
    is_active INTEGER DEFAULT 1,     -- 1 for active, 0 for soft-deleted
    course_category TEXT,            -- student: 'UG' or 'PG'
    course_name TEXT,                -- student: B.Tech, MCA, etc.
    year_of_study TEXT,              -- student: 1st Year, 2nd Year, etc.
    branch TEXT,                     -- student: Specialization (CSE, ECE, etc.)
    is_verified INTEGER DEFAULT 0    -- 1 if email is verified
);
